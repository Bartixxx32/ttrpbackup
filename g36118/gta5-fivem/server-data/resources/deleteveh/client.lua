        ...
        if ( IsPedSittingInAnyVehicle( ped ) ) then 
            ...
            if ( GetPedInVehicleSeat( vehicle, -1 ) == ped ) then 
                ...
                if ( DoesEntityExist( vehicle ) ) then 
                	ShowNotification( "~r~Nie skasowano pojazdu, spruboj jeszcze raz!" )
                else 
                	ShowNotification( "Pojazd Usuniety." )
                end 
            else 
                ShowNotification( "Muszisz Kierowac pojazd aby to zrobic!" )
            end 
        else
            ...
            if ( DoesEntityExist( vehicle ) ) then 
                ...
                ShowNotification( "Musisz byc w Pojedzie albo obok!" )
            end 
        end 
    end 
end )
